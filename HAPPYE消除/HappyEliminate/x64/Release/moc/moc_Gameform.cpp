...
QT_MOC_LITERAL(1, 9, 20), // "SignalSendMapdataone"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 2), // "i1"
QT_MOC_LITERAL(4, 34, 2), // "j1"
QT_MOC_LITERAL(5, 37, 20), // "SignalSendMapdatatwo"
QT_MOC_LITERAL(6, 58, 2), // "i2"
QT_MOC_LITERAL(7, 61, 2) // "j2"

    },
    "Gameform\0SignalSendMapdataone\0\0i1\0j1\0"
...
void Gameform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Gameform::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Gameform::SignalSendMapdataone)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Gameform::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Gameform::SignalSendMapdatatwo)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Gameform::SignalSendMapdataone(int _t1, int _t2)
{
...
// SIGNAL 1
void Gameform::SignalSendMapdatatwo(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
